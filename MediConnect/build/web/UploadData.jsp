    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-6">
                <!-- CONTACT FORM HERE -->
                <form id="appointment-form" role="form" method="post" action="MedicaldataUpload" onsubmit="return confirm('Are you sure you want to upload the data? Once entered, it cannot be modified.');">
                    <!-- SECTION TITLE -->
